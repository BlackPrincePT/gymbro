package com.pegio.gymbro.common.presentation.core

import com.pegio.gymbro.R
import com.pegio.gymbro.common.domain.core.DataError
import com.pegio.gymbro.common.domain.core.Error
...
private fun DataError.Firestore.toStringResId(): Int = when (this) {
    ...
    DataError.Firestore.UNKNOWN -> R.string.firestore_unknown
