...
import com.pegio.gymbro.data.repository.WorkoutPlanRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun bindWorkoutPlanRepository(repository: WorkoutPlanRepositoryImpl): WorkoutPlanRepository
}